...
def home(request):
    ...
    return render(request, 'BD_imagens/index.html', context)
...
def categoryPage(request, slug):
    ...
    return render(request, 'BD_imagens/category.html', context)
...
def imageDetailPage(request, slug1, slug2):
    ...
    return render(request, 'BD_imagens/image.html', context)